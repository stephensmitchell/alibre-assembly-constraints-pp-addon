    ...
    Public Class AddOnRibbon
        ...
        Public Function InvokeCommand(menuId As Integer, sessionIdentifier As String) As IAlibreAddOnCommand Implements IAlibreAddOn.InvokeCommand
            ...
            Catch ex As Exception
                System.Windows.MessageBox.Show("An error occurred while invoking the command:" & vbLf & ex.ToString(),"alibre-assembly-constraints-pp-addon")
            End Try
            Return Nothing
        End Function
        ...
        Public Function MenuItemText(menuId As Integer) As String Implements IAlibreAddOn.MenuItemText
            Select Case menuId
                Case ROOT_ID : Return "Assembly Constraints++"
                Case CMD : Return "Assembly Constraints++ Tool"
